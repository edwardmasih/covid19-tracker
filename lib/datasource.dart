...
Color darkThemeBlack = Color(0xFF294C57);
Color  primaryBlack = Color(0xff202c3b);

class DataSource {

  static String api = "https://corona.lmao.ninja/v2/all";
  static String apiCountry = "https://corona.lmao.ninja/v2/countries";
  
  static String apiIndiaState = "https://api.covid19india.org/data.json";
  
  static String mythBusterLink = "https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/myth-busters";
  static String whoDonateLink = "https://covid19responsefund.org";
